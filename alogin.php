        ...
        <div class="container">
            <div class="row main">
                ...
                <div class="main-content">
                    <form action="includes/alogin.inc.php"id="loginform" method="post" onsubmit="validateEmail()">
                        ...
                        <div class="form-group ">
                            <button name="alogin" type="submit" class="btn btn-danger btn-lg btn-block login-button">Login</a>
                        </div>
