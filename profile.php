    ...
    echo '
      ...
      <div class="col-md-6 col-xs-12 col-sm-6 col-lg-8" >
          <div class="container-details" >
            ...
            <p><b>'.$_SESSION['user_position'].' </b></p>
            ...
            <p><span class="glyphicon glyphicon-envelope one" style="width:50px;"></span>'.$_SESSION['user_email'].'<button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-envelope"></span>Mailbox</button></p>
            <p>Date Of Enrollment:'.$_SESSION['user_doe'].' </p>
      </div>
</div>
</div>
</div>
...
header("Location: ../employee/elogin.php");
exit();
}
?>